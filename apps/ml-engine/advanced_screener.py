"""
Advanced AI Screener untuk Dellmology Pro
Scan semua saham dengan multiple criteria: CNN patterns, broker flow, HAKA/HAKI,
anomaly detection, volatility, dan AI scoring
"""
